...
const Shop = () => {
  ...
  const Category = [
    ...
    { name: "Seeds", type: "seeds", category: "seeds" },
    { name: "Succulents", type: "succulents", category: "succulents" },
    {
      name: "Hedge Plants Herbs",
      type: "hedge-plants-herbs",
      category: "hedge-plants-herbs",
    },
  ];
                ...
                <div className="my-2">
                  <div className="flex gap-4 pb-2">
                    <input
                      ...
                      className="w-20 h-10 rounded-sm px-2 text-center"
                      placeholder="from"
                    />
                    ...
                    <input
                      ...
                      className="w-20 h-10 rounded-sm px-2 text-center font-medium"
                      placeholder="..."
                    />
                  </div>
                </div>
